...
export default function Contact() {
  ...
  const contactInfo = [
    { icon: "📧", label: "Email", value: "contact@mdhossin.com", link: "mailto:contact@mdhossin.com" },
        ...
        >
          <div className="space-y-5">
            {["name", "email", "subject"].map((field) => (
              <div key={field} className="relative">
                <input
                  ...
                  placeholder=" "
                  className="
                    peer w-full px-4 pt-5 pb-2.5 rounded-xl
                    bg-slate-100 border border-slate-300
                    dark:bg-slate-900 dark:border-slate-700
                    text-sm focus:ring-2 focus:ring-blue-500 transition
                  "
                />
                <label
                  className="
                    absolute left-4 top-3 text-sm text-slate-500
                    dark:text-slate-400 pointer-events-none transition-all
            ...
            <button
              ...
              disabled={loading}
              className="
                w-full py-3 rounded-full text-white text-sm font-semibold
